...
<div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
      ...
      <div className="bg-white py-5 px-6  rounded w-[25%]">
        ...
        <div className="mb-5">
                      ...
                      placeholder='Enter Amount' type="text" className="w-full  p-3 border border-gray-300 rounded-[5px]  h-[55px] focus:outline-none focus:border-gray-400 focus:ring-0" />
                  </div>
        </div>
