    ...
    lg:bg-no-repeat py-32 lg:py-0 overflow-hidden'>
        ...
        <div className='flex items-center h-full pt-8'>
            ...
            <div className='lg:hidden mb-8'>
                ...
                <span className='text-5xl  font-body font-bold text-accent lg:text-7xl'>Payback later</span>
               
                {/* <span className='text-4xl lg:text-6xl font-light text-herotext mb-4 lg:mt-2 mt-5' >later</span> */}
                
                <p className='text-lg lg:text-1xl font-light herotext mt-4 mb-4 py-2 lg:py-3 flex  items-center lg:items-start text-center lg:text-start'>
                ...
                <p className='text-lg lg:text-3xl font-light  mb-6 py-2 lg:py-1'>Download our app to get started</p>


                {/* botton */}
                <div className='flex space-x-4'>
                    <a href='/' className='bg-accent text-white px-6 py-3 rounded-[5px] lg:text-lg font-medium'>Google play store</a>
                    <a href='/' className='bg-transparent border-2 border-accent text-accent px-6 py-3 rounded-[5px] lg:text-lg font-medium'>Apple store</a>
                    </div>
            </div>
