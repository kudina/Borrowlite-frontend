        ...
        child={
          <div className="flex justify-center  lg:ml-[35%] lg:mr-[35%] ml-2 mr-2 mt-10 flex-col">
            <h1 className="font-text text-center text-deepGrey font-semibold">
              Please Verify if this is your meter details
            </h1>
            {data.isError ? (
              <div
            ...
            <div className="flex flex-row justify-between mt-3">
              <p className="text-black">Service charge</p>
              <div className="text-black">₦ {servicecharge}</div>
            </div>
            {mdata.paymentmode === "borrow" ? (
              <div className="flex flex-row justify-between mt-3">
                <p className="text-black">Intrest</p>
            ...
            <div className="flex flex-row justify-between mt-10">
              ...
              >
                {data.isLoading || checkref.isLoading || result.isLoading ? (
                  <div
                  ...
                  <span>Payback Amount ₦ {paybackamount}</span>
                ) : (
            ...
            {mdata?.paymentmode === "borrow" ? (
              <>
                {user?.authCode ? null : (
                  <p className="flex flex-row justify-between mt-5 text-sm text-center">
                    50 Naira will be charged from your card for card
                    verification but will be returned to your wallet upon
                    verification, by clicking checkout you agree to Borrowlite's
                    T&C to pay back the amount {paybackamount} within the next
                    14 days
                  </p>
                )}
              </>
