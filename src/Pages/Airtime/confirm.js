      ...
      child={
        <div className="flex  justify-around lg:mt-[15%] mt-[20%]">
          ...
          <div className="mt-4 flex justify-center text-center">
            {
                data?.data?.data?.data?.status ==="COMPLETED" ? <div className="">
                    <div>
                <img src={Reminder} className="w-[10%] h-[30%] ml-[45%] mb-5"/>
                </div>
                    Your transactiion was Successful <br></br>
                    <Link to="/dashboard"><div className="mt-3 text-black"> Return Home</div></Link>
                    </div> :null
                
            }
            {
               data?.data?.data?.data?.status === "PENDING" ? <div className="align-center ">
                <div>
                <img src={Reminder} className="w-[10%] h-[30%] ml-[45%] mb-5"/>
                </div>
                
                Your transaction is Pending <br></br>please check back later<br></br>
                <Link to="/dashboard"><div className="mt-3 text-black"> Return Home</div></Link>
                </div>: null
            }
            {
               data?.data?.data?.data?.status === "FAILD" ? <div className="align-center">
                <div>
                <img src={Reminder} className="w-[10%] h-[30%] ml-[45%] mb-5"/>
                </div>
            ...
            {
                 !data?.data?.data?.data?.status  ?  <div className="justify-center ">
                 <div className=" mt-5 mb-5 inline-block h-20 w-20 animate-spin
